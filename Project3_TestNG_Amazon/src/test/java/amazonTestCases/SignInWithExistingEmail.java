...
public class SignInWithExistingEmail extends CallingProgramAmazon {
	//Test Case: Verify if one can sign in with previously registered email
	WebDriver driver;

	public SignInWithExistingEmail(WebDriver ldriver)
	{
		driver=ldriver;
	...
	@FindBy(xpath="//div[@id='register-mase-inlineerror']/child::div/child::div") WebElement emlmsg;
	...
	{
		Assert.assertTrue(emlmsg.isDisplayed());
		System.out.println(emlmsg.getText()+" is displayed: Verified");
	}
}
