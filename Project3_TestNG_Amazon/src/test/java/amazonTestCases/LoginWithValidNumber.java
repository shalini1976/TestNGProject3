...
public class LoginWithValidNumber extends CallingProgramAmazon {
	//Test case: Verify if one can login with valid phone number
	
	WebDriver driver;

	public LoginWithValidNumber(WebDriver ldriver)
	{
		driver=ldriver;
